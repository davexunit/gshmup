(define-module (gshmup keycodes)
  #:export (keycode gshmup-keycode))

(define keycodes (make-hash-table))
(define gshmup-keycodes (make-hash-table))

(define (keycode key)
  "Returns the integer keyboard code that the given key maps to."
  (hash-ref keycodes key))

(define (gshmup-keycode key)
  "Returns the integer gshmup control keycode that the given key maps to"
  (hash-ref gshmup-keycodes key))
...
(define (init-gshmup-keycodes)
  (hash-set! gshmup-keycodes 'up 0)
  (hash-set! gshmup-keycodes 'down 1)
  (hash-set! gshmup-keycodes 'left 2)
  (hash-set! gshmup-keycodes 'right 3)
  (hash-set! gshmup-keycodes 'shoot 4)
  (hash-set! gshmup-keycodes 'bomb 5)
  (hash-set! gshmup-keycodes 'start 6))

;; Initialize keycodes upon loading module
(init-keycodes)
(init-gshmup-keycodes)
